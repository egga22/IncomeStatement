...
export const defaultTransactions = [
  ...
  { id: 2, name: "Art Supplies", price: -45, gender: "Any", active: true, odds: 1.0 },
  { id: 3, name: "Trendy Jeans", price: -50, gender: "Any", active: true, odds: 1.0 },
  { id: 4, name: "Anime Convention Ticket", price: -150, gender: "Boy", active: true, odds: 1.0 },
  { id: 5, name: "Trendy Nike Sneakers", price: -120, gender: "Boy", active: true, odds: 1.0 },
  { id: 6, name: "Trendy T-shirt", price: -25, gender: "Any", active: true, odds: 1.0 },
  { id: 7, name: "Airsoft Gun", price: -30, gender: "Boy", active: true, odds: 1.0 },
  { id: 8, name: "Skateboard", price: -100, gender: "Boy", active: true, odds: 1.0 },
  { id: 9, name: "New Lego Set", price: -80, gender: "Any", active: true, odds: 1.0 },
  { id: 10, name: "Poster For Room", price: -60, gender: "Any", active: true, odds: 1.0 },
  { id: 11, name: "PS5", price: -500, gender: "Boy", active: true, odds: 1.0 },
  { id: 12, name: "Trendy Haircut", price: -35, gender: "Any", active: true, odds: 1.0 },
  { id: 13, name: "Trendy Baseball Cap", price: -25, gender: "Boy", active: true, odds: 1.0 },
  { id: 14, name: "Gift For Friend", price: -25, gender: "Any", active: true, odds: 1.0 },
  { id: 15, name: "Gift for Girlfriend", price: -35, gender: "Boy", active: true, odds: 1.0 },
  { id: 16, name: "Trendy Graphic Hoodie", price: -45, gender: "Boy", active: true, odds: 1.0 },
  { id: 17, name: "Trendy Backpack", price: -45, gender: "Boy", active: true, odds: 1.0 },
  { id: 18, name: "Music Festival Ticket", price: -300, gender: "Any", active: true, odds: 1.0 },
  { id: 19, name: "Baseball Game Ticket", price: -30, gender: "Boy", active: true, odds: 1.0 },
  ...
  { id: 28, name: "Stanley Cup", price: -50, gender: "Girl", active: true, odds: 1.0 },
  { id: 29, name: "Boba", price: -8, gender: "Girl", active: true, odds: 1.0 },
  { id: 30, name: "Mow The Lawn", price: 10, gender: "Any", active: true, odds: 1.0 },
  { id: 31, name: "Clean The Garage", price: 30, gender: "Any", active: true, odds: 1.0 },
  { id: 32, name: "Deep Clean the Bathroom", price: 70, gender: "Any", active: true, odds: 1.0 },
];
